...
\VeryHuge \color{HoGentAccent1} \textbf{Data-analyse met Elasticsearch} \color{Black}\\ % Title
\huge \textbf{Standaert Ruben, Vanderbeken Ken, De Vreese Sabine}\\[0.5cm] % Author(s)
\huge Hogeschool Gent, Valentin Vaerwyckweg 1, 9000 Gent\\[0.4cm] % University/organization
\Large \texttt{ruben.standaert.w1083@student.hogent.be} \\
\end{minipage}
%
